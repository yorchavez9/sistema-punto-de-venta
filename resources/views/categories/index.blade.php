        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un panel de categoría te permite recopilar y visualizar fácilmente datos de categoría <br> al optimizar la experiencia de categoría, garantizando la retención en la misma. </p>
                </div>
                <div>
                <a href="{{ route('categories.create') }}" class="btn btn-primary add-list"><i class="fas fa-plus mr-3"></i>Crear categoria</a>
                <a href="{{ route('categories.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash mr-3"></i>Borrar búsqueda</a>
                </div>
            </div>
        </div>
