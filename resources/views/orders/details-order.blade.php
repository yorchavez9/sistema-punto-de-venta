            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Información Detalles del pedido</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="form-group col-md-6">
                            <label>Teléfon del cliente</label>
                        ...
                        <div class="form-group col-md-6">
                            <label>Estado del factura</label>
                            ...
                            <div class="col-lg-12">
                                <div class="d-flex align-items-center list-action">
                                    <form action="{{ route('order.updateStatus') }}" method="POST" style="margin-bottom: 5px">
                                        ...
                                        <button type="submit" class="btn btn-success mr-2 border-none" data-toggle="tooltip" data-placement="top" title="" data-original-title="Complete">Orden completa</button>
